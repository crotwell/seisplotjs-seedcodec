...
In most cases this will probably not be used directly and the data will be incoded as compressed data in a miniseed record, and so seisplotjs-miniseed will be used instead.
